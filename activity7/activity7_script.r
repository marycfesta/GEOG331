...
dirR <- "/Users/maryfesta/Documents/Colgate/Academics/Environmental Data Science/GEOG331/activity7/oneida"
...
nnFreq <- freq(nnet_prediction)

#cell count random forest
rfFreq <- freq(rf_prediction)

#### QUESTION 4 ####

# multiply by 400 since the cell is 20m x 20m
# algal bloom is [1,], count is in the second column [2]
rfCount <- rfFreq[1,][2] * 400
nnCount <- nnFreq[1,][2] * 400
...
diffRaster <- abs(nnet_prediction - rf_prediction)  
plot(diffRaster)
